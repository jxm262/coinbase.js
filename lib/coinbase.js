...
function createAccessSign(reqType, timestamp, subUrl, params){
...
function createAuthRequest(api) {
    ...
    return function (params) {
        ...
        var subUrl = spice(api.subUrl, pathParam);
        ...
        var headers = {
            ...
            "CB-ACCESS-SIGN" : createAccessSignd(api.reqType, timestamp, subUrl, params),
            "CB-ACCESS-TIMESTAMP" : timestamp,
            "CB-ACCESS-PASSPHRASE" : self._passPhrase
        };

        return request('GET', root_url + subUrl).set(headers);
    };
};
